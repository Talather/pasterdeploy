...
export default function Main() {
  ...
  const [isHoveringInsertTemplate, setIsHoveringInsertTemplate] =
    useState(false);
  const navigate = useNavigate();
  //   const generateLink = `/page/${encodeURIComponent(title)}/${encodeURIComponent(
  //     content
  //   )}`;

  return (
    <div className="background min-h-screen text-gray-300 p-4 flex flex-col font-mono ">
      <main>
        <div className="flex-grow flex flex-col max-w-4xl mx-auto w-full space-y-4 min-w-[85%] my-12">
          <div className="relative">
            <input
              ...
              className="w-full bg-transparent border-none text-2xl font-semibold placeholder-white focus:outline-none"
              placeholder="Title"
            />
          </div>
          <div className="relative flex-grow">
            <textarea
              ...
              className="w-full h-full min-h-[300px] bg-transparent border-none resize-none placeholder-white  focus:outline-none"
        ...
        <div className="flex justify-between items-center max-w-4xl mx-auto w-full space-y-4 border-b border-white min-w-[85%] my-12 pb-1.5">
          <div className="flex flex-col space-x-4">
            ...
            <div className="flex gap-6 items-center text-gray-500 text-xs">
              <span className="text-sm font-semibold text-start text-white">
                Tools
              </span>
              <div className="relative group ">
                <button
                  className="flex gap-2 px-2 py-1 text-gray-500  rounded hover:bg-[#20212b]"
                ...
                >
                  ...
                  <span className="text-white">Insert template</span>
                </button>
          ...
          <button
            className="bg-[#575AC6] text-white px-4 py-2 rounded text-xs font-semibold"
            onClick={() => {
