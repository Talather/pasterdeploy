...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="background text-gray-300 px-8 py-4 border-b border-[#3c3d4d] ">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <img
              src="https://paster.so/brand/assets/icon/standard.svg"
              alt=""
              className="w-6 h-6"
            />

            <svg
              className="text-[#3c3d4d]"
              fill="none"
              height="20"
            ...
            >
              ...
              {isHoveringAdFree && (
                <div className="absolute top-full left-2 mt-2 z-10">
                  <div
                    className="flex justify-center items-center gap-2 border border-[#3c3d4d] px-2 py-1 rounded-md 
